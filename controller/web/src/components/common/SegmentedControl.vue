...
// 复用自 zashboard（MIT）：iOS 风格分段控件（替代 el-radio-group/el-tabs 的轻量切换）
...
<style scoped>
/* 滑动指示条过渡 */
.ios-segment-indicator-ready {
  transition: transform 0.25s cubic-bezier(0.32, 0.72, 0, 1), width 0.2s ease-out;
}
